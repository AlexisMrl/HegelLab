...
supported_instruments = {
    ...
    "be214x": {
        ...
        "has_address": True,
        "address": "TCPIP::192.168.150.145::5025::SOCKET",
        "has_slots": True,
        "slots": [1, 2, 3, 4],  # 4 instruments in one
        "has_channels": True,
        "channels": [1, 2, 3, 4],  # 4 channel per instr
        "channel_key": "ch",
        "has_custom_driver": False,
        "devices_name": [
            "output_en",
    ...
    "dmm344xxA": {
        ...
        "has_address": True,
        "address": "USB0::0x2A8D::0x0101::MY57515472",
        "has_slots": False,
        "has_channels": False,
        "has_custom_driver": False,
    ...
    "ami430": {
        ...
        "has_address": True,
        "address": "TCPIP::{ip_name}-AX.local::7180::socket",
        "has_slots": False,
        "has_channels": False,
        "has_custom_driver": True,
...
class HegelLab:
    ...
    def loadGuiInstrument(self, gui_instr):
        ...
        try:
            ...
            gui_instr.ph_instr = gui_instr.instr_driver.load(
                gui_instr.nickname, gui_instr.instr_cls, gui_instr.address, **kwargs
            )
        ...
        for gui_dev in gui_instr.gui_devices.values():
            ...
            try:
                gui_dev.ph_dev = self.model.getDevice(
                    gui_instr.ph_instr, gui_dev.dev_name
                )
    ...
    def buildGuiInstrument(self, nickname, instr_name, addr, slot=None):
        ...
        instr_driver = (
            settings["driver"] if settings["has_custom_driver"] else Drivers.Default
        )
        gui_instr = GuiInstrument(
            nickname, instr_name, instr_cls, instr_driver, addr, slot
        )
        print(addr)
    ...
    def createWrapDevice(
        self, base_gui_dev, dev_type, ph_kwargs, gui_dev_nickname, base_hide
    ):
